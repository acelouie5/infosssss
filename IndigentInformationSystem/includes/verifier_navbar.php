...
<!-- Sidebar - Brand -->
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="../verifier/verifier_dashboard.php">
    <div class="sidebar-brand-icon">
        <i class="fas fa-user-tie"></i>
    </div>
    <div class="sidebar-brand-text mx-3">Verifier</div>
</a>
...
<li class="nav-item active">
    <a class="nav-link" href="../verifier/verifier_dashboard.php">
...
<li class="nav-item">
    <a class="nav-link" href="../verifier/releasing_forms.php">
